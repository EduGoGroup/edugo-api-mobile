...
```
📍 Ruta: tracking/REGLAS.md (dentro de 03-api-mobile/)
📍 Carpeta base: 03-api-mobile/
...
- Branch: feature/sprint-2-20251120
- Último commit: feat(sprint-2): completar tarea 2.5
