# 📋 Guía de Migración: edugo-shared v2.0.1 → v2.0.5

## 🎯 Objetivo

Migrar proyectos de la versión monolítica **v2.0.1** a la arquitectura modular **v2.0.5** de edugo-shared, donde cada proyecto solo descarga los submódulos que realmente necesita.

---

## 📦 Cambio Principal

### Antes (v2.0.1) - Monolítico ❌
```go
// go.mod
...
| Import Antiguo (v2.0.1) | Import Nuevo (v2.0.5) | Submódulo |
|-------------------------|----------------------|-----------|
...
find . -name "*.go" -type f -not -path "./vendor/*" -exec sed -i '' \
  ...
  -e 's|github.com/EduGoGroup/edugo-shared/v2/pkg/types/enum|github.com/EduGoGroup/edugo-shared/common/types/enum|g' \
...
1. `github.com/EduGoGroup/edugo-shared/v2/pkg/errors` → `github.com/EduGoGroup/edugo-shared/common/errors`
2. `github.com/EduGoGroup/edugo-shared/v2/pkg/types/enum` → `github.com/EduGoGroup/edugo-shared/common/types/enum`
3. `github.com/EduGoGroup/edugo-shared/v2/pkg/types` → `github.com/EduGoGroup/edugo-shared/common/types`
4. `github.com/EduGoGroup/edugo-shared/v2/pkg/validator` → `github.com/EduGoGroup/edugo-shared/common/validator`
5. `github.com/EduGoGroup/edugo-shared/v2/pkg/auth` → `github.com/EduGoGroup/edugo-shared/auth`
6. `github.com/EduGoGroup/edugo-shared/v2/pkg/logger` → `github.com/EduGoGroup/edugo-shared/logger`
...
```
Necesito migrar mi proyecto Go de edugo-shared v2.0.1 (monolítico) a v2.0.5 (modular).

CONTEXTO:
- La versión v2.0.1 era un módulo monolítico que descargaba todas las dependencias
